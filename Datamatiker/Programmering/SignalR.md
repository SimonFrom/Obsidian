...
**SignalR** er et bibliotek, der kan bruges til at udvikle realtidswebapplikationer i .NET Core. SignalR indeholder en API, der giver server-side kode mulighed for at sende beskeder til tilsluttede klient webbrowsere. Derudover er der god cross platform support, SDK'er kan fåes til JavaScript, C#, F#, Visual Basic og Java. SignalR gør det muligt at pushe beskeder og information direkte til klienten.
...
Men den bedste transport bliver altid benyttet først:
1. Websockets
