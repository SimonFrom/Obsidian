- Hvad er mit emne og hvad dækker det over?
	- React Native er et framework til at udvikle moderne og responsive websider og cross platform applikationer. React Native er som navnet antyder lavet til at rendere native elementer på hvilken som helst platform. 
	- "Learn once, write anywhere"

- Hvor har min research indtil nu ført mig hen?

- Hvad ønsker jeg på nuværende tidspunkt at mit endemål skal være?
	- Designe og implementere responsive brugergrænseflader cross platform
	- API kald og håndtere data asynkront
